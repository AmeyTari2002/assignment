...
const Navbar = () => {
    ...
    return (
        <div className='bg-[#212731] max-w-screen   h-[64px]  lg:w-[1614px] pl-10 md:pl-36 text-white flex items-center justify-between px-4 md:justify-center lg:gap-[60px] font-Inter text-[14px] '>
